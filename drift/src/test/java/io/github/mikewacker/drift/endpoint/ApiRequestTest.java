...
public final class ApiRequestTest {
    ...
    public void handleApiRequest_ZeroArg() throws Exception {
        ApiRequest.Factory<Sender.Value<Integer>, Void, Void, Void, Void> requestFactory =
                ApiRequest.Factory.zeroArg(Adder::add0);
        ApiRequest<Sender.Value<Integer>, Void, Void, Void, Void> request =
    ...
    public void handleApiRequest_OneArg() throws Exception {
        ApiRequest.Factory<Sender.Value<Integer>, Integer, Void, Void, Void> requestFactory =
                ApiRequest.Factory.oneArg(Adder::add1);
        ApiRequest<Sender.Value<Integer>, Integer, Void, Void, Void> request =
                requestFactory.createWithUnsetArgs(sender, dispatcher);
        request.setArg1(1);
        request.handle();
    ...
    public void handleApiRequest_TwoArg() throws Exception {
        ApiRequest.Factory<Sender.Value<Integer>, Integer, Integer, Void, Void> requestFactory =
                ApiRequest.Factory.twoArg(Adder::add2);
        ApiRequest<Sender.Value<Integer>, Integer, Integer, Void, Void> request =
                requestFactory.createWithUnsetArgs(sender, dispatcher);
        request.setArg1(1);
        request.setArg2(2);
        request.handle();
    ...
    public void handleApiRequest_ThreeArg() throws Exception {
        ApiRequest.Factory<Sender.Value<Integer>, Integer, Integer, Integer, Void> requestFactory =
                ApiRequest.Factory.threeArg(Adder::add3);
        ApiRequest<Sender.Value<Integer>, Integer, Integer, Integer, Void> request =
                requestFactory.createWithUnsetArgs(sender, dispatcher);
        request.setArg1(1);
        request.setArg2(2);
        request.setArg3(3);
    ...
    public void handleApiRequest_FourArg() throws Exception {
        ApiRequest.Factory<Sender.Value<Integer>, Integer, Integer, Integer, Integer> requestFactory =
                ApiRequest.Factory.fourArg(Adder::add4);
        ApiRequest<Sender.Value<Integer>, Integer, Integer, Integer, Integer> request =
                requestFactory.createWithUnsetArgs(sender, dispatcher);
        request.setArg1(1);
        request.setArg2(2);
        request.setArg3(3);
